...
import ru.zinoviev.quest.request.handler.domain.dto.request.PollRequest;
...
public class CreatorPollActionDispatcher extends ActionDispatcher {
    ...
    public CreatorPollActionDispatcher(ResponsePublisher publisher, PropertiesReader propertiesReader) {
