...
public class PlayerMessageActionDispatcher extends ActionDispatcher {
    ...
    public PlayerMessageActionDispatcher(ResponseFactory responseFactory, ResponsePublisher publisher, KeyboardRegistry keyboardRegistry, MessageRegistry messageRegistry) {
