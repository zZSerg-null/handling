...
public final class TelegramPoll extends TelegramRequest {
    ...
    @Builder
    public TelegramPoll(Long userId, String userName, String firstName, String lastName, Integer messageId,
                        String pollId, String question, String explanation,
                        PollType type, Boolean allowMultipleAnswers, List<String> answers,
