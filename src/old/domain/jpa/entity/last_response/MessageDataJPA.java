...
public class MessageDataJPA {
    ...
    private List<MessageEntityDataJPA> entity; // фишки текста сообщения, типа подчеркивания, спойлера и прочего
    ...
    @OneToOne(cascade = CascadeType.ALL)
    private SendFileJPA sendFileJPA; //если просто посылаем файл
